                    ...
                    <div class="card-body">
                        <form
                            ...
                            <div class="row mb-3">
                                ...
                                <div class=" col-md-6 mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="inputCity" name="published_at"
                                           value="{{ isset($exam) ? \Carbon\Carbon::parse($exam->published_at)->format('Y-m-d\TH:i') : \Carbon\Carbon::now()->format('Y-m-d\TH:i') }}" required>
                                ...
                                <div class=" col-md-6">
                                    ...
                                    <input type="datetime-local" class="form-control" id="inputCity" name="expired_at"
                                           value="{{ isset($exam) ? \Carbon\Carbon::parse($exam->expired_at)->format('Y-m-d\TH:i') : \Carbon\Carbon::now()->format('Y-m-d\TH:i') }}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2">
                                    <input type="radio" name="result_published" value="1" id="result_published"
                                           class="form-check-input" required
                                        {{ isset($exam) && $exam->result_published == 1 ? 'checked' : '' }}>
                                    <label for="result_published">Published</label>
                                </div>
                                <div class="col-md-2">
                                    <input type="radio" name="result_published" value="0" id="result_un_published"
                                           class="form-check-input" required
                                        {{ isset($exam) && $exam->result_published == 0 ? 'checked' : '' }}>
                                    <label for="result_un_published">UnPublished</label>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2">
                                    <input type="radio" name="paper_published" value="1" id="paper_published"
                                           class="form-check-input" required
                                        {{ isset($exam) && $exam->paper_published == 1 ? 'checked' : '' }}>
                                    <label for="paper_published">Published</label>
                                </div>
                                <div class="col-md-2">
                                    <input type="radio" name="paper_published" value="0" id="paper_unpublished"
                                           class="form-check-input" required
                                        {{ isset($exam) && $exam->paper_published == 0 ? 'checked' : '' }}>
                                    <label for="paper_unpublished">UnPublished</label>
                                </div>
                            </div>
